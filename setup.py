...
setup(
    ...
    url='https://github.com/adafruit/Adafruit_CircuitPython_INA219',
    ...
    keywords='adafruit current sensor high voltage featherwing breakout hardware micropython circuitpython',

    # You can just specify the packages manually here if your project is
    # simple. Or you can use find_packages().
    py_modules=['adafruit_ina219'],
)
